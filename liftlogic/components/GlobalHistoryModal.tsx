      ...
      <div className="bg-slate-900 w-full max-w-md rounded-2xl border border-slate-700 max-h-[90vh] flex flex-col shadow-2xl">
        ...
        <div className="p-4 border-b border-slate-800 flex justify-between items-center bg-slate-800/50 rounded-t-2xl">
          ...
          <div className="flex items-center gap-2">
            {!isImporting ? (
              <>
                <button 
                  ...
                  className="p-2 text-slate-400 hover:text-white hover:bg-slate-700 rounded-lg focus-visible:ring-2 focus-visible:ring-blue-500 outline-none transition-colors"
                  title="Import Data"
                ...
                <button 
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 active:bg-slate-600 text-blue-400 text-xs font-bold uppercase tracking-wider rounded-lg border border-slate-700 focus-visible:ring-2 focus-visible:ring-blue-500 outline-none transition-all"
                >
              ...
              <button 
                ...
                className="text-slate-400 hover:text-white text-sm font-medium px-2 rounded-lg focus-visible:ring-2 focus-visible:ring-blue-500 outline-none transition-colors"
              >
                Cancel
              </button>
            )}
            <button
              onClick={onClose}
              className="text-slate-400 hover:text-white p-2 rounded-lg hover:bg-slate-800 focus-visible:ring-2 focus-visible:ring-blue-500 outline-none transition-colors"
              aria-label="Close"
            >
              <X size={24} />
            </button>
        ...
        {isImporting ? (
           <div className="p-6 flex-1 flex flex-col gap-4">
             ...
             <button 
               ...
               className="w-full bg-blue-600 hover:bg-blue-500 active:bg-blue-700 text-white font-bold py-3 rounded-xl focus-visible:ring-2 focus-visible:ring-blue-400 outline-none transition-all shadow-lg shadow-blue-900/20"
             >
               Import Logs
             </button>
           </div>
