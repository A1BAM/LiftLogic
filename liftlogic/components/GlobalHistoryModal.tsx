        ...
        {isImporting ? (
           <div className="p-6 flex-1 flex flex-col gap-4">
             ...
             <button 
               ...
               className="w-full bg-blue-600 hover:bg-blue-500 active:bg-blue-700 text-white font-bold py-3 rounded-xl focus-visible:ring-2 focus-visible:ring-blue-400 transition-all shadow-lg shadow-blue-900/20"
             >
               Import Logs
             </button>
           </div>
