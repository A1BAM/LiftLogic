      ...
      <div className="bg-slate-900 w-full max-w-md rounded-2xl border border-slate-700 max-h-[90vh] flex flex-col shadow-2xl">
        ...
        <div className="p-4 border-b border-slate-800 flex justify-between items-center bg-slate-800/50 rounded-t-2xl">
          ...
          <div className="flex items-center gap-2">
            {!isImporting ? (
              <>
                ...
                <button 
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 active:bg-slate-600 text-blue-400 text-xs font-bold uppercase tracking-wider rounded-lg border border-slate-700 transition-all focus-visible:ring-2 focus-visible:ring-blue-400 outline-none"
                >
              ...
              <button 
                ...
                className="text-slate-400 hover:text-white text-sm font-medium px-2 rounded focus-visible:ring-2 focus-visible:ring-blue-500 outline-none"
              >
                Cancel
              </button>
            )}
            <button
              onClick={onClose}
              className="text-slate-400 hover:text-white p-2 rounded-lg focus-visible:ring-2 focus-visible:ring-blue-500 outline-none"
              aria-label="Close"
            >
              <X size={24} />
            </button>
        ...
        {isImporting ? (
           <div className="p-6 flex-1 flex flex-col gap-4">
             ...
             <textarea 
               className="flex-1 bg-slate-950 border border-slate-700 rounded-xl p-4 text-xs font-mono text-slate-300 focus:outline-none focus:border-blue-500 focus-visible:ring-2 focus-visible:ring-blue-500 resize-none min-h-[200px] outline-none"
             ...
             <button 
               ...
               className="w-full bg-blue-600 hover:bg-blue-500 active:bg-blue-700 text-white font-bold py-3 rounded-xl transition-all shadow-lg shadow-blue-900/20 focus-visible:ring-2 focus-visible:ring-blue-400 outline-none"
             >
               Import Logs
             </button>
           </div>
