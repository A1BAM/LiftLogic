          ...
          <div className="flex items-center gap-2">
            {!isImporting ? (
              ...
              <button 
                ...
                className="text-slate-400 hover:text-white text-sm font-medium px-2 hover:bg-slate-700 rounded-lg focus-visible:ring-2 focus-visible:ring-blue-500 transition-colors"
              >
                Cancel
              </button>
            )}
