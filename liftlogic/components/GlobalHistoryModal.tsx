            ...
            {!isImporting ? (
              <>
                ...
                <button 
                  ...
                  aria-label={copied ? "Data copied to clipboard" : "Export workout history JSON"}
                >
              ...
              <button 
                ...
                className="text-slate-400 hover:text-white text-sm font-medium px-2 focus-visible:ring-2 focus-visible:ring-blue-500 rounded outline-none"
              >
                Cancel
              </button>
            )}
