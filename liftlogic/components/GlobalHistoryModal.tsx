            ...
            {!isImporting ? (
              <>
                ...
                <button 
                  ...
                  aria-label="Export history to clipboard"
                >
              ...
              <button 
                ...
                className="text-slate-400 hover:text-white text-sm font-medium px-2 rounded-lg focus-visible:ring-2 focus-visible:ring-blue-500"
              >
                Cancel
              </button>
            )}
