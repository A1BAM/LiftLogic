              ...
              <div key={ex.id} className="bg-slate-950 p-4 rounded-xl border border-slate-800 flex justify-between items-center group">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className="p-2 bg-blue-900/20 text-blue-400 hover:bg-blue-600 hover:text-white rounded-lg border border-blue-900/50 focus-visible:ring-2 focus-visible:ring-amber-500 transition-colors"
                    title="Restore"
                  ...
                  <button 
                    ...
                    className="p-2 bg-red-900/10 text-red-500 hover:bg-red-600 hover:text-white rounded-lg border border-red-900/30 focus-visible:ring-2 focus-visible:ring-red-500 transition-colors"
