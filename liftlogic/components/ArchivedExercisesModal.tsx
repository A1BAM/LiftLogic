              ...
              <div key={ex.id} className="bg-slate-950 p-4 rounded-xl border border-slate-800 flex justify-between items-center group">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className="p-2 bg-blue-900/20 text-blue-400 hover:bg-blue-600 hover:text-white rounded-lg border border-blue-900/50 focus-visible:ring-2 focus-visible:ring-blue-500 transition-colors outline-none"
                  ...
                  <button 
                    ...
                    className="p-2 bg-red-900/10 text-red-500 hover:bg-red-600 hover:text-white rounded-lg border border-red-900/30 focus-visible:ring-2 focus-visible:ring-red-500 transition-colors outline-none"
                    aria-label={`Delete ${ex.name} permanently`}
