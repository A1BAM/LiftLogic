          ...
          <form onSubmit={handleAddSet} className="bg-slate-950 p-4 rounded-2xl border border-slate-800 shadow-inner">
             ...
             <div className="grid grid-cols-2 gap-4 mb-4">
                ...
                <div className="bg-slate-900 p-3 rounded-xl border border-slate-800">
                  <label htmlFor="weight-input" className="block text-slate-500 text-[10px] font-bold uppercase mb-2 text-center cursor-pointer">Weight</label>
                  <div className="flex items-center justify-between">
                    ...
                    <input
                      ...
                      className="w-16 bg-transparent text-xl font-bold text-white font-mono text-center focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded"
                    />
                    <button
                      type="button"
                      onClick={() => adjustWeight(5)}
             ...
             <button 
              type="submit" 
              disabled={reps < 1}
              className="w-full bg-blue-600 hover:bg-blue-500 active:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-4 rounded-xl shadow-lg shadow-blue-900/20 flex items-center justify-center gap-2 focus-visible:ring-2 focus-visible:ring-blue-400 transition-all"
            >
              <Plus size={20} />
              Add Set
            </button>
