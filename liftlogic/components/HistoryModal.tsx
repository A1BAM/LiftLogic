                ...
                <div key={log.id} className="bg-slate-800 p-3 rounded-lg flex justify-between items-center border border-slate-700">
                  ...
                  <div className="flex gap-2">
                     <button 
                      type="button"
                      onClick={() => onEdit(log)}
                      className="p-2 text-slate-400 hover:text-blue-400 hover:bg-slate-700 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-blue-500"
                      aria-label="Edit log"
                    >
                      <Edit2 size={18} />
                    </button>
                    <button 
                      ...
                      className="p-2 text-slate-400 hover:text-red-400 hover:bg-slate-700 rounded-lg transition-colors focus-visible:ring-2 focus-visible:ring-red-500"
